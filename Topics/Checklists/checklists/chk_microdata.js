...
[1,"De-identification"],
  [2,"Make sure all personally-identifying information (PII) is removed! If you wish to deposit all variables in the survey for completeness, create de-identified versions of variables containing PII as described below and attach a list of all PII variables that should not be released to you submission"],
  ...
  [2,"If results haven't been published yet, list any variables identifying treatment assignment and flag them as embargoed on the submission form"],
